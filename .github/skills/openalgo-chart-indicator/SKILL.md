...
From 2.5.6, an input that only matters for some settings takes `visibleWhen` or
...
[indicators](../openalgo-charts/references/indicators.md#conditional-inputs-and-inline-rows-256).
