...
|---|---|---|---|
| Base engine | `openalgo-charts.mjs` | 67 KB | 66.42 KB |
| Base + trade layer | base + `trade.mjs` | 75 KB | 74.03 KB |
...
| Widget terminal | base + `draw.mjs` + `indicators.mjs` + `widget.mjs` | 156 KB | 155.06 KB |
| Everything | all eight bundles | 183 KB | 182.37 KB |
