...
describe('demo modules', () => {
  it('lists the modules the README documents', () => {
    expect(MODULES).toEqual([
      ...
      'drawing.js', 'expression.js', 'feed.js', 'goto.js', 'grid-view.js', 'grid.js', 'history.js', 'hover.js', 'indicator-input-controls.js', 'indicator-source.js', 'indicator-templates.js', 'indicators.js', 'inspection.js', 'intervals.js', 'level-editor.js',
