...
Professional interactive charts, 102 built-in indicators plus your own custom ones, drawing tools, order flow, market replay, linked chart grids, and on-chart trading. Six lazy-loaded tiers, zero runtime dependencies, 61.81 KB Brotli for the base engine.
...
[![bundle](https://img.shields.io/badge/brotli-61%20KB%20base%20%C2%B7%20135%20KB%20all%20tiers-brightgreen.svg)](#size-budget)
...
|---|---|---|
| `openalgo-charts` | Engine, 13 chart types, panes &amp; scales, primitives, registries, chart state, chart linking, bar cache, interval registry, trading overlay, OpenAlgo feeds | 61.8 KB |
...
Everything together is **135.13 KB Brotli**. Figures are the measured `size-limit` output. The trade tier is listed as its delta over the base, so loading base + trade costs 69.42 KB.
