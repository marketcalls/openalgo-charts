...
const diagram = '/openalgo-charts/architecture-diagram.svg?v=2.1.9';
    ...
    <figure className="oac-architecture">
      ...
      <div className="oac-architecture__viewport" tabIndex={0} role="region" aria-label="Architecture diagram, scroll to explore at actual size">
        <img src={diagram} width={1600} height={1100}
          ...
          alt="OpenAlgo Charts 2.1.9: custom host or widget, seven capability layers, Canvas 2D and optional WebGL2 rendering, compact profiles, drawing model v2, and eight bundle tiers totalling 203.62 KB Brotli." />
      </div>
