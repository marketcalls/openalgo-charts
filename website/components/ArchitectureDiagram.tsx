...
const diagram = '/openalgo-charts/architecture-diagram.svg?v=2.5.5-architecture-1';
    ...
    <figure className="oac-architecture">
      ...
      <div className="oac-architecture__viewport" tabIndex={0} role="region" aria-label="Host boundary, base engine and optional tiers; scroll to explore at actual size">
        <img src={diagram} width={1280} height={1520}
          ...
          alt="OpenAlgo Charts 2.5.5 architecture: a custom host or widget owns data connections and application authority above the base engine's data-to-model-to-render pipeline, alerts, replay and linking, interaction, state and CSV. Eight optional tiers: indicators, draw, profile, transform, trade, workspace, WebGL and widget." />
      </div>
