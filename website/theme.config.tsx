...
const config = {
  ...
  footer: {
    content: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 4, fontSize: '0.85rem' }}>
        <span>Apache-2.0 - Original, dependency-free code - 66.45 KB Brotli base engine</span>
  ...
  head: function Head() {
    ...
    const description =
      ...
      'A from-scratch, dependency-free HTML5-canvas charting engine for OpenAlgo: 15 chart types, 102 built-in indicators plus your own, 51 drawing tools, on-chart trading, and live data, from a 66.45 KB base engine.';
    return (
      <>
