  ...
  footer: {
    content: (
      <div className="oac-site-footer">
        ...
        <div className="oac-site-footer__bottom"><Link href="/docs/release-notes#257">OpenAlgo Charts 2.5.7</Link><a href={`${REPO}/blob/master/LICENSE`} target="_blank" rel="noreferrer">Free and open source · Apache-2.0</a></div>
      </div>
    ),
  },
  head: function Head() {
