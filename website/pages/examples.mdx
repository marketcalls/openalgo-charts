...
import NavigationMobileDemo from '../components/NavigationMobileDemo'
...
[navigation and mobile](#navigation-and-mobile), [market profiles](#compact-market-profiles), [chart controls](#interactive),
or [trading](#trading).

## Navigation and mobile

Try pixel-precise trackpad movement, a wheel, horizontal or Shift-wheel panning,
and wheel scaling over either price axis. The narrow layout exposes the packaged
mobile header and drawing controls; widening the same container restores the desktop
chrome. See [Interactions](/docs/interactions), [Mobile and Touch](/docs/mobile), and
[The Widget Tier](/docs/widget).
