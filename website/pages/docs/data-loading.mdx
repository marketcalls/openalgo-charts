...
column's first, lowest, highest and last values, and histograms its lowest and
highest bar, which cover the pixels every bar would have. A custom chart type is
