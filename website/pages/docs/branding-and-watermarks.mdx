...
Anything else under the pointer comes first: a note pinned to the screen over the corner,
a drawing crossing it or an order line takes the press, the drag, the hover and the double
click, and the logo answers only where nothing else does.
