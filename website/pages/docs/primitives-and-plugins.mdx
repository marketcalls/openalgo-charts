...
placed primitive repaints with the base canvas whatever its `zOrder()`. This is how the
draw tier puts a drawing between studies; see [Draw order](/docs/drawing-tools#draw-order).
