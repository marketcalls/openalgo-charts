...
| `movable` | Whether legacy `movePriceAxis` can reassign this built-in side ID to the other ID. It does not govern column placement. |
...
The legacy `movePriceAxis(pane, 'right', 'left')` instead swaps the built-in side
